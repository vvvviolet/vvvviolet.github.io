	...
	final class ZOOM_Customizer_Reset {
		...
		public function customize_controls_print_scripts() {
			...
			wp_localize_script( 'zoom-customizer-reset', '_ZoomCustomizerReset', array(
				'reset'   => __( 'Reset', 'montblanc' ),
				'confirm' => __( 'Be brave, all custom settings will be reset. This action is irreversible.', 'montblanc' ),
				'nonce'   => array(
					'reset' => wp_create_nonce( 'montblanc' ),
				)
			) );
		}
		/**
		...
		public function ajax_customizer_reset() {
			...
			if ( ! check_ajax_referer( 'montblanc', 'nonce', false ) ) {
